...
function Window(options) {
  ...
  // TODO: per spec, `location` should be a getter on `Document`, and `window`'s getter should delegate to
  // `this.document.location`: https://html.spec.whatwg.org/multipage/browsers.html#dom-document-location
  // This would remove the need to pass in `url` as an option to `Window`.
